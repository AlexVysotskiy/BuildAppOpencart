...
--
-- Хост: localhost
-- Время создания: Фев 17 2017 г., 13:48
...
(1, 'jtJCfMCoqjwkthuRrVvtNqKYWwzPtXEuZpt2BXKGmtNXzaNMtsCf4S9wdX69BrNl', '', '', '', 1, '2017-02-17 09:25:22', '2017-02-17 09:25:22');

-- --------------------------------------------------------

--
-- Структура таблицы `oc_api_oauth_client`
--
...
--
-- Структура таблицы `oc_api_oauth_session_access_token`
--
...
(2, 'US Dollar', 'USD', '$', '', '2', 1.00000000, 1, '2017-02-17 13:44:53'),
...
(2, 'Русский', 'ru', 'ru,ru_RU,ru_RU.UTF-8', 'ru.png', 'russian', 0, 1);
...
(1, 'Opencart API', 'com.opencart.restapi', 'Opencart API', '1.3.1', 'http://opencart2-api.herokuapp.com/docs/latest', '<?xml version="1.0" encoding="utf-8"?>\n<modification>\n    <name>Opencart API</name>\n    <version>1.3.1</version>\n    <author>Opencart API</author>\n    <link>http://opencart2-api.herokuapp.com/docs/latest</link>\n    <code>com.opencart.restapi</code>\n    <file path="admin/controller/common/menu.php">\n        <operation>\n            \n            <search><![CDATA[$data[''text_feed''] = $this->language->get(''text_feed'');]]></search>\n\n            <add position="after"><![CDATA[      $data[''text_api''] = $this->language->get(''text_api'');\n    $data[''text_api_oauth_clients''] = $this->language->get(''text_api_oauth_clients'');\n    $data[''text_api_settings''] = $this->language->get(''text_api_settings'');]]></add>\n                \n        </operation>\n\n        <operation>\n        \n            <search><![CDATA[$data[''feed'']]]></search>\n\n            <add position="after"><![CDATA[      $data[''api_oauth_clients''] = $this->url->link(''api/oauth_client'', ''token='' . $this->session->data[''token''], ''SSL'');\n    $data[''api_settings''] = $this->url->link(''api/setting'', ''token='' . $this->session->data[''token''], ''SSL'');]]></add>\n                \n        </operation>\n    </file>  \n\n    <file path="admin/language/english/common/menu.php">\n        <operation>\n            \n            <search><![CDATA[$_[''text_feed'']]]></search>\n            \n            <add position="after"><![CDATA[$_[''text_api'']                         = ''API'';\n$_[''text_api_oauth_clients'']           = ''OAuth clients'';\n$_[''text_api_settings'']                = ''Settings'';]]></add>\n                \n        </operation>\n    </file>\n\n    <file path="admin/view/template/common/menu.tpl">\n        <operation>\n            \n            <search><![CDATA[<li><a href="<?php echo $feed; ?>"><?php echo $text_feed; ?></a></li>]]></search>\n            \n            <add position="after"><![CDATA[          <li><a class="parent"><?php echo $text_api; ?></a>\n    <ul>\n      <li><a href="<?php echo $api_oauth_clients; ?>"><?php echo $text_api_oauth_clients; ?></a></li>\n      <li><a href="<?php echo $api_settings; ?>"><?php echo $text_api_settings; ?></a></li>\n    </ul>\n  </li>]]></add>\n                \n        </operation>\n    </file>\n\n</modification>', 1, '2017-02-17 12:45:20');
...
(301, 0, 'config', 'config_language', 'ru', 0),
(302, 0, 'config', 'config_admin_language', 'ru', 0),
(291, 0, 'config', 'config_image', '', 0),
(290, 0, 'config', 'config_fax', '', 0),
(289, 0, 'config', 'config_telephone', '123456789', 0),
(288, 0, 'config', 'config_email', 'admin@admin.com', 0),
...
(384, 0, 'config', 'config_seo_url', '0', 0),
...
(388, 0, 'config', 'config_maintenance', '1', 0),
(389, 0, 'config', 'config_password', '1', 0),
(390, 0, 'config', 'config_encryption', '9f4aaade95d7a1e46df660fe39ae78a4', 0),
...
(1, 1, 'admin', '466121c9ae17e8496e1a05fcc89cf26102293a4a', 'ba1f094d7', 'John', 'Doe', 'admin@admin.com', '', '', '::1', 1, '2017-02-17 09:25:22');
...
ALTER TABLE `oc_api_oauth_client`
 ADD PRIMARY KEY (`oauth_client_id`), ADD UNIQUE KEY `u_apoacl_client_secret_client_id` (`client_secret`,`client_id`);

--
-- Indexes for table `oc_api_oauth_session_access_token`
--
ALTER TABLE `oc_api_oauth_session_access_token`
 ADD PRIMARY KEY (`oauth_session_access_token_id`), ADD UNIQUE KEY `u_apoaseacto_access_token` (`access_token`), ADD KEY `i_apoaseacto_client_id` (`client_id`);
...
--
ALTER TABLE `oc_setting`
MODIFY `setting_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=400;
--
