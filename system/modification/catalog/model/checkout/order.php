...
class ModelCheckoutOrder extends Model {
	public function addOrder($data) {
		...
		shipping_climbing = '" . $this->db->escape($data['shipping_climbing']) . "', 
		shipping_lift = '" . $this->db->escape($data['shipping_lift']) . "', 
		shipping_winch = '" . $this->db->escape($data['shipping_winch']) . "', 
		shipping_unloading = '" . $this->db->escape($data['shipping_unloading']) . "', 
		shipping_weight_line = '" . $this->db->escape($data['shipping_weight_line']) . "', 
		shipping_garbage = '" . $this->db->escape($data['shipping_garbage']) . "', 
