	...
	public function getOrder($order_id) {
		...
		if ($order_query->num_rows) {
			...
			return array(
                ...
                'shipping_climbing'       => $order_query->row['shipping_climbing'],
                'shipping_lift'           => $order_query->row['shipping_lift'],
                'shipping_winch'          => $order_query->row['shipping_winch'],
                'shipping_unloading'      => $order_query->row['shipping_unloading'],
                'shipping_weight_line'    => $order_query->row['shipping_weight_line'],
                'shipping_garbage'        => $order_query->row['shipping_garbage'],
