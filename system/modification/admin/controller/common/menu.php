...
class ControllerCommonMenu extends Controller
{
    ...
    public function index()
    {
        ...
        $data['api_oauth_clients'] = $this->url->link('api/oauth_client', 'token=' . $this->session->data['token'], 'SSL');
        $data['api_settings'] = $this->url->link('api/setting', 'token=' . $this->session->data['token'], 'SSL');
