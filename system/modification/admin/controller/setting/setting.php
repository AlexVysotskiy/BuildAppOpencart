...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
        ...
        $data['entry_config_state_app'] = $this->language->get('entry_config_state_app');
        ...
        $data['help_config_state_app'] = $this->language->get('help_config_state_app');
        ...
        if (isset($this->request->post['config_state_app'])) {
            $data['config_state_app'] = $this->request->post['config_state_app'];
        } else {
            $data['config_state_app'] = $this->config->get('config_state_app');
        }
