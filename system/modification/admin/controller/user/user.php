...
class ControllerUserUser extends Controller {
	...
	protected function getForm() {
        ...
        $data['entry_user_group_franchise'] = $this->language->get('entry_user_group_franchise');
        ...
        if (isset($this->request->post['user_group_franchise_id'])) {
            $data['user_group_franchise_id'] = $this->request->post['user_group_franchise_id'];
        } elseif (!empty($user_info)) {
            $data['user_group_franchise_id'] = $user_info['user_group_franchise_id'];
        } else {
            $data['user_group_franchise_id'] = '';
        }
