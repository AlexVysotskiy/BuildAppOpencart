      ...
      <div class="panel-body">
        <form class="form-horizontal">
          <ul id="order" class="nav nav-tabs nav-justified">
            <li class="disabled1 active"><a href="#tab-customer" data-toggle="tab">1. <?php echo $tab_customer; ?></a></li>
            <li class="disabled1"><a href="#tab-cart" data-toggle="tab">2. <?php echo $tab_product; ?></a></li>
            <li class="disabled1"><a href="#tab-payment" data-toggle="tab">3. <?php echo $tab_payment; ?></a></li>
            <li class="disabled1"><a href="#tab-shipping" data-toggle="tab">4. <?php echo $tab_shipping; ?></a></li>
            <li class="disabled1"><a href="#tab-total" data-toggle="tab">5. <?php echo $tab_total; ?></a></li>
          </ul>
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-total">
              ...
              <div class="row">
                <div class="col-sm-6 text-left">
                  <button type="button" onclick="$('select[name=\'shipping_method\']').prop('disabled1') ? $('a[href=\'#tab-payment\']').tab('show') : $('a[href=\'#tab-shipping\']').tab('show');" class="btn btn-default"><i class="fa fa-arrow-left"></i> <?php echo $button_back; ?></button>
                </div>
                <div class="col-sm-6 text-right">
	...
	$.ajax({
		...
		success: function(json) {
			...
			if (!shipping) {
				...
				$('select[name=\'shipping_method\']').prop('disabled1', true);
				$('#button-shipping-method').prop('disabled1', true);
			} else {
				$('select[name=\'shipping_method\']').prop('disabled1', false);
				$('#button-shipping-method').prop('disabled1', false);				
			}
			...
			if (json['error']) {
				...
				$.ajax({
					...
					beforeSend: function() {
						...
						$('#button-payment-address').prop('disabled1', true);
					},
					complete: function() {
						$('#button-payment-address i').replaceWith('<i class="fa fa-arrow-right"></i>');
						$('#button-payment-address').prop('disabled1', false);
					},
					success: function(json) {
						if (json['error']) {
							$('#content > .container-fluid').prepend('<div class="alert alert-danger"><i class="fa fa-exclamation-circle"></i> ' + json['error'] + ' <button type="button" class="close" data-dismiss="alert">&times;</button></div>');
				...
				if ($('select[name=\'shipping_method\']').prop('disabled1')) {
			...
			if (json['error']) {
				...
				$.ajax({
					...
					beforeSend: function() {
						...
						$('#button-shipping-address').prop('disabled1', true);
					},
					complete: function() {
						$('#button-shipping-address i').replaceWith('<i class="fa fa-arrow-right"></i>');
						$('#button-shipping-address').prop('disabled1', false);
					},
					success: function(json) {
						if (json['error']) {
							$('#content > .container-fluid').prepend('<div class="alert alert-danger"><i class="fa fa-exclamation-circle"></i> ' + json['error'] + ' <button type="button" class="close" data-dismiss="alert">&times;</button></div>');
							...
							if (json['shipping_methods']) {
								for (i in json['shipping_methods']) {
									...
									if (!json['shipping_methods'][i]['error']) {
										...
										html += '<option value="" style="color: #F00;" disabled1="disabled1">' + json['shipping_method'][i]['error'] + '</option>';
									}
