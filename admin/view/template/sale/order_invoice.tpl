    ...
    <body>
        <div class="container">
            ...
            <div style="page-break-after: always;">
                <h1>
                    <img src="view/image/logo.png" alt="Opencart" title="123">
                    ...
                    <tbody>
                        <tr>
                            <td style="width: 50%;">
                                ...
                                <b>
                                    <?php echo $text_fax; ?>
                                </b> <?php echo $order['store_fax']; ?>
                                <br />
                                <?php } ?>
                                <b>
                                    <?php echo $text_email; ?>
                                </b> <?php echo $order['store_email']; ?><br />
                                <!--<b>
                                    <?php echo $text_website; ?>
                                </b>
                    ...
                    <tbody>
                        <tr>
                            <td>
                                <address>
                                    <div>
                                        <?php echo $order['order_info']['firstname'] . ' ' .  $order['order_info']['lastname']; ?>
                                    </div>
                                    <div>
                                        <?php echo $order['order_info']['telephone']; ?>
                                    </div>
                                </address>
                            </td>
                            <td>
                                <address>
                                    <?php echo $order['order_info']['payment_city'] . ', ' . $order['order_info']['payment_address_1']; ?>
                                </address>
                            </td>
                        </tr>
                    </tbody>
                ...
                <table class="table table-bordered">
                    <thead>
                        <tr>
                            ...
                            <td class="text-right"><b>Вес (кг.)</b></td>
                    ...
                    <tbody>
                        ...
                        <?php if($total['title'] == 'Итого' || $total['code'] == 'weight'): ?>
                        <tr>
