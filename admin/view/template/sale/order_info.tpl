        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="tab-order">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td>
                                    <b>
                                        <?php echo  $payment_city . ', ' . $payment_address_1 . ($payment_postcode ? ', ' . $payment_postcode : ''); ?>
                                    </b>
                                </td>
                            </tr>
                    ...
                    <!--<div class="tab-pane123" id="tab-payment">
                        <table class="table table-bordered">
                            <tr>
                    ...
                    <?php if ($shipping_method) { ?>
                    <!--<div class="tab-pane123" id="tab-shipping">
                        <table class="table table-bordered">
                            <tr>
                                <td><?php echo $text_firstname; ?></td>
                    ...
                    <?php if ($payment_action) { ?>
                    <div class="tab-pane123" id="tab-action"><?php echo $payment_action; ?></div>
                    <?php } ?>
                    <?php if ($frauds) { ?>
                    <?php foreach ($frauds as $fraud) { ?>
                    <div class="tab-pane123" id="tab-<?php echo $fraud['code']; ?>">
