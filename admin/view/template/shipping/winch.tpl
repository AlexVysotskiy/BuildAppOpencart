            ...
            <tbody>
              ...
              <?php foreach ($options as $option) { ?>
                <tr id="option-value-row<?php echo $option_value_row; ?>">
                  ...
                  <td class="text-right">
                    <p class="text-left"><?php echo $first_price; ?></p>
                    <input type="text" name="option_value[<?php echo $option_value_row; ?>][first_price]" value="<?php echo $option['first_price']; ?>" class="form-control" /></td>
                  </td>
...
function addOptionValue() {
    ...
    html += '  <td class="text-right"><p class="text-left"><?php echo $first_price; ?></p><input type="text" name="option_value[' + option_value_row + '][first_price]" value="" placeholder="<?php echo $entry_sort_order; ?>" class="form-control" /></td>';
